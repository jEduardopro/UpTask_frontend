							...
							<div className="sm:flex sm:items-start">
								<div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
									...
									<form className='my-10' onSubmit={handleSubmit}>
										...
										<div className='mb-5'>
											<label htmlFor="description" className='text-gray-700 text-sm font-bold'>Description</label>
											<textarea
												id='description'
										...
										<div className='mb-5'>
											<label htmlFor="priority" className='text-gray-700 text-sm font-bold'>Priority</label>
											<select
												id='priority'
